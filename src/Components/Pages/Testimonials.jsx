...
const Testimonials = () => {
  return (
    <div>
      <div className="container pb-20 md:pb-0 bg-gray dark:bg-black md:h-screen py-8 flex flex-col gap-8 w-full">
        <div>
        ...
        >
          <div className="relative">
            ...
            <p className="relative z-10 text-lg md:text-xl text-gray-600 font-light leading-relaxed mb-8 pl-8 border-l-2 border-primary">
              &quot;I have been so impressed with your work, you have given us a
              major push on the project. Thank you&quot;
            </p>
