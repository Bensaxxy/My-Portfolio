...
const AboutMe = () => {
  ...
  return (
    <motion.div
      ...
      className="container bg-gray py-8 flex justify-center lg:h-screen w-full"
    >
      <div>
        {/* About Me Title */}
        <motion.h1
          variants={childVariants}
          className="text-center border px-10 border-zinc-300 tracking-widest font-extrabold text-4xl md:text-5xl lg:text-7xl uppercase"
        >
          About Me
        </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div
            ...
            className="bg-black p-10 grid gap-8 grid-cols-2 md:grid-cols-2"
          >
            {[
              { number: "5+", label: "YEARS EXPERIENCE" },
              { number: "160+", label: "PROJECTS DONE" },
              ...
              <motion.div
                key={index}
                variants={childVariants}
                className="text-gray text-center p-2"
              >
          ...
          <motion.div variants={containerVariants}>
            <motion.h1
              variants={childVariants}
              className="font-semibold  text-xl mb-4 tracking-wider"
            >
              What I Do?
            </motion.h1>
